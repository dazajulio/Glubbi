...
export default function GlubbiAccount() {
  ...
  const menuItems = [
    { title: 'Historial de Pedidos', icon: Receipt, href: '/glubbi/cuenta/pedidos', color: 'text-blue-500', bg: 'bg-blue-50' },
    ...
    { title: 'Términos y Condiciones', icon: FileText, href: '/terminos', color: 'text-gray-500', bg: 'bg-gray-100' },
    { title: 'Políticas de Privacidad', icon: ShieldCheck, href: '/privacidad', color: 'text-gray-500', bg: 'bg-gray-100' },
    { title: 'Tratamiento de Datos', icon: ShieldCheck, href: '/privacidad', color: 'text-gray-500', bg: 'bg-gray-100' },
  ];
